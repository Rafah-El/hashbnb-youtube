...
const Perks = () => {
  ...
  return (
    <div className='grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4'>
             <label 
             htmlFor="wifi" 
             className='cursor-pointer flex gap-2 items-center px-4 py-3 rounded-xl border border-gray-300'>
              <input 
                type="checkbox"
                id="wifi"
                value={'wifi'}
             ...
             <label htmlFor="parking" className='cursor-pointer flex gap-2 items-center px-4 py-3 rounded-xl border border-gray-300'>
              <input 
                type="checkbox"
                id="parking"
                value={'parking'}
